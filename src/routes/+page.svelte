<script lang="ts">
	...
	const defaultPlans = [
		...
		},
		{
			...
			features: [
				...
				'Pembayaran QRIS/VA/e-wallet (Mayar)',
	...
	const defaultFaqs = [
		...
		},
		{
			...
			a: 'Tunai, QRIS, kartu debit, virtual account, dan e-wallet melalui integrasi Mayar. Pembayaran digital dibuat sebagai invoice dan diverifikasi otomatis lewat webhook.'
		},
		{
