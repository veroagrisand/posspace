-- ============================================================
-- posspace — migration 0007: hardening keamanan fungsi atomik
-- 1) process_transaction: validasi qty>0, harga>=0, shift milik toko,
--    pembayaran cash harus cukup
-- 2) record_purchase: wajib peran pemilik/admin_gudang + validasi input
-- ============================================================
...
begin
  ...
  -- 3) Update total + pastikan pembayaran cash mencukupi
...
-- record_purchase: wajib pemilik/admin_gudang + validasi input
...
begin
  ...
  -- HANYA pemilik/admin gudang yang boleh mencatat pembelian & menambah stok
