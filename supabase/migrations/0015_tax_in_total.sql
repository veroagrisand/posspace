-- ============================================================
-- posspace — migration 0015: pajak & layanan 10% masuk total transaksi
-- Sebelumnya v_total hanya menjumlah harga item; pajak 10% hanya
-- ditambahkan di tampilan frontend sehingga nominal Snap Midtrans,
-- kembalian tunai, dan laporan tidak cocok dengan total kasir.
-- Sekarang DB menghitung: subtotal → pajak round(subtotal*0.1) → total.
-- ============================================================
